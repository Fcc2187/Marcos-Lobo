...
export const escociaPost = {
  ...
  content: `
    ...
    <p>Em um grupo que não era cotada como a "favorita" conseguiu um feito e tanto, pra fechar bem a campanha aplicou um 4-2 na Dinamarca ${flags.dinamarca} em Glasgow o que lhe rendeu a liderança e a classificação direta ao mundial. 🗺️</p>
    <h2 style="margin-top: 40px; color: #ffd700; border-bottom: 2px solid #ffd700; padding-bottom: 8px;">PRINCIPAIS ESTRELAS ${flags.escocia}⭐</h2>
    ...
    <p style="margin-top: 30px; font-weight: 500; font-size: 1.15rem; line-height: 1.8;">
      A Escócia também tem pela frente o jogo mais acessível do grupo diante do Haiti ${flags.haiti}, é mais do quê crucial somar os 3 pontos pois para se classificar em um grupo com Brasil ${flags.brasil} e Marrocos ${flags.marrocos} é primordial, vale visar as melhores opções da seleção escocesa.
    </p>
  `
};
