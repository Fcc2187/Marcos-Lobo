export const austriaPost = {
  ...
  content: `
    ...
    <p style="margin-top: 30px; font-weight: 500; font-size: 1.15rem; line-height: 1.8;">
      Acredito que vale muito a pena investir nas peças austríacas na 1ª rodada, pois farão o confronto contra o adversário teoricamente mais acessível do grupo — que também conta com as fortíssimas seleções de Argentina <img src="https://flagcdn.com/w20/ar.png" alt="🇦🇷" style="vertical-align: middle; height: 14px; margin-bottom: 2px; border-radius: 2px;"> e Argélia <img src="https://flagcdn.com/w20/dz.png" alt="🇩🇿" style="vertical-align: middle; height: 14px; margin-bottom: 2px; border-radius: 2px;">. Um resultado positivo convincente é essencial diante da Jordânia <img src="https://flagcdn.com/w20/jo.png" alt="🇯🇴" style="vertical-align: middle; height: 14px; margin-bottom: 2px; border-radius: 2px;">, e a construção de saldo de gols pode vir a ser o grande diferencial de classificação! Olho neles. <img src="https://flagcdn.com/w20/at.png" alt="🇦🇹" style="vertical-align: middle; height: 14px; margin-bottom: 2px; border-radius: 2px;">
    </p>
  `
};
